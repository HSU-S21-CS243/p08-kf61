...
public:
	...
	virtual string ToAsm()
	{
		...
		result << "@SP\t\t\t//begin GREATER THAN command" << endl;
		...
		//M register = X, D regiser = Y, subtract Y from X if result is >0 then X gt Y
		result << "D=M-D" << endl;
		//create label for isgreaterthan jump
		result << "@:isgreaterthan" << _counter << endl;
		//if result is greater than zero jump to greater than
		result << "D;JGT" << endl;
		//create label for islessthan jump
		result << "@:islessthan" << _counter << endl;
		result << "0;JMP" << endl;
		//label for isgreater than jump, set result -1
		result << "(:isgreaterthan" << _counter << ")" << endl;
		result << "D=-1" << endl;
		result << "@:greaterthanend" << _counter << endl;
		result << "0;JMP" << endl;
		//label for islessthan jump, keep d=0 
		result << "(:islessthan" << _counter << ")" << endl;
		result << "D=0" << endl;
		result << "@:greaterthanend" << _counter << endl;
		result << "0;JMP" << endl;
